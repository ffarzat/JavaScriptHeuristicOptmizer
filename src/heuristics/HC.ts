...
export default class HC extends IHeuristic {
    ...
    */
        ...
        this.SetLibrary(library, (sucess: boolean) => {
            if (sucess) {
                ...
                switch (this.nodesSelectionApproach) {
                    ...
                    this.runByFunction(trialIndex, (results: TrialResults)=>{
    ...
    {
        //Pegar a AST da Funcao a ser trabalhada nesse momento.
        this.GetFunctionAstByName(this.bestIndividual, "maxFromBits");
        
        //Jogar como bestIndividual
        //Deixar terminar

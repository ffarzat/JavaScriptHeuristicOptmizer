    ...
    Test(individual: Individual) {
        ...
        try {
            ...
            if (this.AvailableHosts == undefined || this.AvailableHosts.length == 0) {
                ...
                testCMD = `mpirun -n ${testUntil} -host ${hosts} -x PATH=$PATH:node=/mnt/scratch/user8/nodev4/node-v4.4.7/out/Release/node:npm=/mnt/scratch/user8/nodev4/node-v4.4.7/out/bin/npm executeNPM.sh ${libPath}`;

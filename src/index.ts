...
var uniquePool = new pool(__dirname + '/Child.js', [configFile, Ncpus, hostfile] , {execArgv: ['--expose-gc','--max-old-space-size=102400'] }, { size: configuration.clientsTotal + 1, log: false, timeout: configuration.copyFileTimeout * 1000 });

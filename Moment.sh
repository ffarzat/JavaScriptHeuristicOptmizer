...
npm run PBS
node --expose-gc --max-old-space-size=102400 build/src/index.js Configs/Moment.json &
mpirun -np 142 node --expose-gc --max-old-space-size=102400 build/src/Sockets/runClients.js Configs/Moment.json
date
